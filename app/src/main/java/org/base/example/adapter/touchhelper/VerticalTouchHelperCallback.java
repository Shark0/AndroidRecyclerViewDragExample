...
public class VerticalTouchHelperCallback extends ItemTouchHelper.Callback {

    private final String TAG = "VerticalTouchHelperCallback";

    private TouchListener listener;

    public VerticalTouchHelperCallback(TouchListener listener) {
